...
public abstract class Critter {
	//TODO appended code for Project5
	...
	/**TODO Make sure that look follows these rules in our implementation
	 * When implementing look you must respect the simulation rule that all critters move
	 simultaneously during their doTimeStep. So, if a critter invokes look during
	 doTimeStep, then the result of calling look is based on the old position of the critter
	 (before it moved this time step, if it has) and based on the old positions of all the other
	 critters (before they move this time step).
	 Conversely (and consistent with Part 1), if a critter invokes look during its fight
	 method, then the result of calling look is based on the most current up-to-date
	 information. Any walk/run effect is processed immediately in the arbitrary order that you
	...
	/** TODO make sure these rules are implemented
	 * One source of confusion might be to decide when to remove dead critters from their
	 location. Remove dead critters that have died during doTimeStep after doTimeStep. After
	 fighting, remove dead critters right away. If there are some corner cases for these rules,
	 implement anything reasonable, and document your behavior in your README file
	 */
	...
	public static String runStats(List<Critter> critters) {
		//TODO all print/println changed to StringBuilder for concatenation
		StringBuilder start = new StringBuilder(("" + critters.size() + " critters as follows -- "));
		java.util.Map<String, Integer> critter_count = new java.util.HashMap<String, Integer>();
		for (Critter crit : critters) {
			String crit_string = crit.toString();
			critter_count.merge(crit_string, 1, (a, b) -> a + b);
...
//			}
		...
		//TODO does this need to be in the Critter class for the testing to work or can it be
		//TODO in our CritterWorld class --> refer to CritterGiven for given structure
